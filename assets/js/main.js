document.addEventListener("DOMContentLoaded", function () {
    ...
    // Initialize SweetScroll and Particles.js (existing code)
    new SweetScroll({});
    particlesJS("particles-js", {
        ...
        interactivity: {
            ...
            modes: { grab: { distance: 400, line_linked: { opacity: 1 } }, bubble: { distance: 400, size: 40, duration: 2, opacity: 8, speed: 3 }, repulse: { distance: 200, duration: .4 }, push: { particles_nb: 4 }, remove: { particles_nb: 2 } }
        },
        retina_detect: !0
    });
